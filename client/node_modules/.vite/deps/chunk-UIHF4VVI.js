...
import {
  ...
  useInput
} from "./chunk-W5HMIKOL.js";
import {
  generateUtilityClass,
  generateUtilityClasses
} from "./chunk-ZPBQKK7Q.js";
import {
  DropdownActionTypes,
  DropdownContext
} from "./chunk-POHG6V6K.js";
import {
  useControllableReducer
} from "./chunk-FOHKT3JT.js";
import {
  useButton
...
function useMenuButton(parameters = {}) {
  ...
  const menuContext = React3.useContext(DropdownContext);
  if (menuContext === null) {
...
function useTabs(parameters) {
  ...
  const onSelected = React9.useCallback((event, newValue) => {
    setValue(newValue);
  ...
  const tabIdLookup = React9.useRef(() => void 0);
  const getTabPanelId = React9.useCallback((tabValue) => {
    var _tabPanels$get;
    return (_tabPanels$get = tabPanels.get(tabValue)) == null ? void 0 : _tabPanels$get.id;
  }, [tabPanels]);
  const getTabId = React9.useCallback((tabPanelId) => {
    return tabIdLookup.current(tabPanelId);
  }, []);
  const registerTabIdLookup = React9.useCallback((lookupFunction) => {
...
function TabsProvider(props) {
  ...
  const compoundComponentContextValue = React11.useMemo(() => ({
    getItemIndex,
    registerItem,
    totalSubitemCount
  }), [registerItem, getItemIndex, totalSubitemCount]);
  ...
  return (0, import_jsx_runtime3.jsx)(CompoundComponentContext.Provider, {
    value: compoundComponentContextValue,
    children: (0, import_jsx_runtime3.jsx)(TabsContext.Provider, {
...
var Tabs = React12.forwardRef(function Tabs2(props, forwardedRef) {
  var _slots$root;
  const {
    children,
    orientation = "horizontal",
  ...
  return (0, import_jsx_runtime4.jsx)(TabsRoot, _extends({}, tabsRootProps, {
    children: (0, import_jsx_runtime4.jsx)(TabsProvider, {
      value: contextValue,
      children
    })
  }));
...
function useTabPanel(parameters) {
  ...
  const metadata = React13.useMemo(() => ({
    id,
    ref
  }), [id]);
  const {
...
function useTabsList(parameters) {
  ...
  const tabIdLookup = React14.useCallback((tabValue) => {
    var _subitems$get;
  ...
  const getTabElement = React14.useCallback((tabValue) => {
  ...
  const handleChange = React14.useCallback((event, newValue) => {
    var _newValue$;
    onSelected(event, (_newValue$ = newValue[0]) != null ? _newValue$ : null);
  }, [onSelected]);
  const controlledProps = React14.useMemo(() => {
    if (value === void 0) {
      return {};
    }
    return value != null ? {
  ...
  const isItemDisabled = React14.useCallback((item) => {
  ...
  const {
    ...
    reducerActionContext: React14.useMemo(() => ({
  ...
  const contextValue = React14.useMemo(() => _extends({}, compoundComponentContextValue, listContextValue), [compoundComponentContextValue, listContextValue]);
  return {
    contextValue,
    dispatch,
    getRootProps,
...
function useNumberInput(parameters) {
  ...
  const handleStateChange = React32.useCallback((event, field, fieldValue, reason) => {
  ...
  const numberInputActionContext = React32.useMemo(() => {
    return {
      min: min2,
      max: max2,
      step,
  ...
  const controlledState = React32.useMemo(() => ({
    value: valueProp
  }), [valueProp]);
  const [state, dispatch] = useControllableReducer({
    ...
    initialState,
    onStateChange: handleStateChange,
    actionContext: React32.useMemo(() => numberInputActionContext, [numberInputActionContext]),
    componentName
  });
  const {
    value,
...
var TabsList = React43.forwardRef(function TabsList2(props, forwardedRef) {
  var _slots$root;
  const {
    children,
    slotProps = {},
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-UIHF4VVI.js.map
