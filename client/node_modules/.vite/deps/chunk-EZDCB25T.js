...
} from "./chunk-4RXA6QJT.js";
import {
  FocusTrap,
  useModal
} from "./chunk-3RYYQ4SW.js";
import {
  useOption,
  useOptionContextStabilizer
} from "./chunk-EACAOFXZ.js";
import {
  useFormControlContext,
  useInput
} from "./chunk-XFRIO5OA.js";
import {
  MenuProvider,
  useMenu
} from "./chunk-U6K2FEZG.js";
import {
  Portal
} from "./chunk-USLJINKB.js";
import {
  require_react_dom
...
import {
  ...
  useList,
  useListItem
} from "./chunk-HBA6CP5E.js";
import {
  generateUtilityClass,
  generateUtilityClasses
} from "./chunk-2K5MSQEI.js";
import {
  DropdownActionTypes,
  DropdownContext
} from "./chunk-DSRI4ZKK.js";
import {
  useControllableReducer
} from "./chunk-MZRDSLX4.js";
import {
  useButton
} from "./chunk-PYMPNTH6.js";
import {
  areArraysEqual,
...
true ? Input.propTypes = {
   ...
   */
  maxRows: import_prop_types4.default.number,
  /**
   * Minimum number of rows to display when multiline option is set to true.
   */
  minRows: import_prop_types4.default.number,
  /**
   ...
   */
  rows: import_prop_types4.default.number,
  /**
  ...
  slots: import_prop_types4.default.shape({
    ...
    textarea: import_prop_types4.default.elementType
  }),
  /**
   ...
   * @default 'text'
   */
  type: import_prop_types4.default.oneOf(["button", "checkbox", "color", "date", "datetime-local", "email", "file", "hidden", "image", "month", "number", "password", "radio", "range", "reset", "search", "submit", "tel", "text", "time", "url", "week"]),
  /**
...
var TransitionContext = React10.createContext(null);
if (true) {
...
function useTransitionStateManager() {
  const transitionContext = React11.useContext(TransitionContext);
...
function useTransitionTrigger(requestEnter) {
  const [exitTransitionFinished, setExitTransitionFinished] = React12.useState(true);
  const hasPendingExitTransition = React12.useRef(false);
  const registeredTransitions = React12.useRef(0);
  const [hasTransition, setHasTransition] = React12.useState(false);
  const previousRequestEnter = React12.useRef(requestEnter);
  React12.useEffect(() => {
  ...
  const handleExited = React12.useCallback(() => {
    hasPendingExitTransition.current = false;
    setExitTransitionFinished(true);
  }, []);
  const registerTransition = React12.useCallback(() => {
...
var PopupContext = React13.createContext(null);
if (true) {
...
var Popup = React14.forwardRef(function Popup2(props, forwardedRef) {
  var _slots$root;
  const {
    anchor: anchorProp,
    children,
  ...
  const popupContextValue = React14.useMemo(() => ({
    placement: finalPlacement
  }), [finalPlacement]);
...
var Menu = React15.forwardRef(function Menu2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime9.jsx)(Popup, _extends({
    keepMounted: true
  }, rootProps, {
    open,
    anchor,
...
true ? Menu.propTypes = {
   ...
   */
  onItemsChange: import_prop_types6.default.func,
  /**
...
var MenuButton = React16.forwardRef(function MenuButton2(props, forwardedRef) {
  const {
    children,
    disabled = false,
    slots = {},
...
var InnerMenuItem = React17.memo(React17.forwardRef(function MenuItem(props, forwardedRef) {
  var _slots$root;
  const {
    children,
...
var MenuItem2 = React17.forwardRef(function MenuItem3(props, ref) {
  const {
    id: idProp
  } = props;
  const {
  ...
  return (0, import_jsx_runtime11.jsx)(ListContext.Provider, {
    value: contextValue,
    children: (0, import_jsx_runtime11.jsx)(InnerMenuItem, _extends({}, props, {
      id,
      ref
    }))
  });
...
true ? MenuItem2.propTypes = {
   ...
   * @default false
   */
  disableFocusOnHover: import_prop_types8.default.bool,
  /**
...
var Modal = React18.forwardRef(function Modal2(props, forwardedRef) {
  var _slots$root;
  const {
    children,
...
function useNumberInput(parameters) {
  ...
  const handleStateChange = React20.useCallback((event, field, fieldValue, reason) => {
  ...
  const numberInputActionContext = React20.useMemo(() => {
    return {
      min: min2,
      max: max2,
      step,
  ...
  const [state, dispatch] = useControllableReducer({
    ...
    initialState,
    onStateChange: handleStateChange,
    actionContext: React20.useMemo(() => numberInputActionContext, [numberInputActionContext]),
    componentName
  });
  const {
    value,
...
var NumberInput = React21.forwardRef(function NumberInput2(props, forwardedRef) {
...
var OptionGroup = React22.forwardRef(function OptionGroup2(props, forwardedRef) {
  const {
    disabled = false,
    slotProps = {},
    slots = {}
...
var InnerOption = React23.memo(React23.forwardRef(function Option(props, forwardedRef) {
...
var Option2 = React23.forwardRef(function Option3(props, ref) {
  const {
    value
  } = props;
  const {
...
var Select = React24.forwardRef(function Select2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime21.jsxs)(React24.Fragment, {
    ...
    })), buttonDefined && (0, import_jsx_runtime20.jsx)(Popup, _extends({
      slots: {
        root: PopupComponent
      }
    }, popupProps, {
...
true ? Select.propTypes = {
  ...
  slotProps: import_prop_types14.default.shape({
    ...
    popup: import_prop_types14.default.oneOfType([import_prop_types14.default.func, import_prop_types14.default.object]),
  ...
  slots: import_prop_types14.default.shape({
    ...
    popup: import_prop_types14.default.elementType,
...
true ? Slider.propTypes = {
   ...
   * @default 10
   */
  shiftStep: import_prop_types15.default.number,
  /**
...
var _excluded23 = ["children", "className", "enterAnimationName", "enterClassName", "exitAnimationName", "exitClassName"];
function CssAnimation(props) {
  ...
  const hasExited = React44.useRef(true);
  React44.useEffect(() => {
    if (requestedEnter && hasExited.current) {
      hasExited.current = false;
    }
  }, [requestedEnter]);
  const handleAnimationEnd = React44.useCallback((event) => {
...
var _excluded24 = ["children", "className", "lastTransitionedPropertyOnExit", "enterClassName", "exitClassName"];
var CssTransition = React45.forwardRef(function CssTransition2(props, forwardedRef) {
  const {
    children,
    className,
  ...
  const [isEntering, setIsEntering] = React45.useState(false);
  React45.useEffect(() => {
    if (requestedEnter) {
  ...
  const handleTransitionEnd = React45.useCallback((event) => {
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-EZDCB25T.js.map
